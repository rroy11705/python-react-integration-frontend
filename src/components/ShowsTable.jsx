...
import { useFetchShows, useRemoveShow } from '../api/queries/shows.queries';
import CreateUpdateShowForm from './CreateUpdateShowForm';
...
const Actions = ({ row }) => {
  ...
  return (
    <div>
      <CreateUpdateShowForm data={row.original} modalId={`update-show-${row.original.id}`} />
...
const ShowsTable = () => {
  ...
  return (
    <div className='wrapper'>
      <CreateUpdateShowForm modalId="create-update-show" />
